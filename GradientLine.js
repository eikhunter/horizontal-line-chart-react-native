...
import { ScrollView, StyleSheet, Dimensions, SafeAreaView, View } from 'react-native'
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.body}>
          <View style={styles.stats}>
            <GraphStatBox total={DATA[pinIndex + 5].value} date={DATA[pinIndex + 5].date}/>
          </View>
          <ScrollView
            bounce={false}
            ...
            <LineChart
              ...
              contentInset={{ top: 30, left: 0, right: 0, bottom: 10 }}
            >
            </LineChart>
          </ScrollView>
        </View>
